export interface SerachGiftResponse {
  data: Gift[];
...
export class Convert {
  public static toSerachGiftResponse(json: string): SerachGiftResponse {
    return cast(JSON.parse(json), r("SerachGiftResponse"));
  }

  public static serachGiftResponseToJson(value: SerachGiftResponse): string {
    return JSON.stringify(uncast(value, r("SerachGiftResponse")), null, 2);
  }
}
